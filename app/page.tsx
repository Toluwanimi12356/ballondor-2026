...
export default function Home() {
  ...
  async function sharePick() {
    if (!selected) return;
    const shareUrl = `https://ballondor-2026.vercel.app/player/${selected.slug}`;
    const message = `My 2026 Ballon d'Or vote goes to ${selected.name} 🏆\n\nEight candidates.\nOne winner.\n\nCast your vote: ${shareUrl}`;
